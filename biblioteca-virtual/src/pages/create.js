...
export default function Create() {
  ...
  function handleOnChangeFile(e) {
    ...
    const reader = new FileReader(); //Leer una imagen de forma local

    reader.readAsDataURL(file); //Leer una imagen de forma local

    reader.onloadend = function () {
      setCover(reader.result.toString()); //Leer una imagen de forma local
    };
  }
